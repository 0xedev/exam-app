...
const mockQuestions: Question[] = [
  ...
  },
  {
    ...
    category: "Principles and Practices of Large-Scale Programming",
    question:
      "What is a common challenge in large-scale software development?",
    options: [
  ...
  },
  {
    id: 10,
    category: "Information Security Management",
    question: "What is the main goal of risk management in information security?",
    options: [
  ...
  },
  {
    ...
    category: "Internet of Things (IoT)",
    question:
      "What is a common communication protocol used in IoT?",
    options: [
      "MQTT",
      "HTTP",
      "FTP",
  ...
  },
  {
    ...
    category: "Real-time and Control Systems",
    question:
      "Which of the following is crucial in real-time systems?",
    options: [
  ...
  },
  {
    ...
    category: "Real-time and Control Systems",
    question:
      "What is an example of a control system in engineering?",
    options: [
  ...
  },
  {
    ...
    category: "Responsible Computing",
    question:
      "Why is accessibility important in responsible computing?",
    options: [
...
export const getLeaderBoard = async () => {
  // Fetch the leaderboard data from the view
  const { data: leaderboardData, error } = await supabase
    .from('leaderboard_view')  // Query the view
    .select('*');
